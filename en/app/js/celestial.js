...
const Celestial = {
  ...
  // ── Zodiac Signs ──────────────────────────────────────────
  zodiacSigns: [
    { id: 'aries', emoji: '♈',       element: 'fire',  modality: 'cardinal', ruler: 'mars',    startMonth: 3,  startDay: 21, endMonth: 4,  endDay: 19 },
    { id: 'taurus', emoji: '♉',      element: 'earth', modality: 'fixed',    ruler: 'venus',   startMonth: 4,  startDay: 20, endMonth: 5,  endDay: 20 },
    { id: 'gemini', emoji: '♊',      element: 'air',   modality: 'mutable',  ruler: 'mercury', startMonth: 5,  startDay: 21, endMonth: 6,  endDay: 20 },
    { id: 'cancer', emoji: '♋',      element: 'water', modality: 'cardinal', ruler: 'moon',    startMonth: 6,  startDay: 21, endMonth: 7,  endDay: 22 },
    { id: 'leo', emoji: '♌',         element: 'fire',  modality: 'fixed',    ruler: 'sun',     startMonth: 7,  startDay: 23, endMonth: 8,  endDay: 22 },
    { id: 'virgo', emoji: '♍',       element: 'earth', modality: 'mutable',  ruler: 'mercury', startMonth: 8,  startDay: 23, endMonth: 9,  endDay: 22 },
    { id: 'libra', emoji: '♎',       element: 'air',   modality: 'cardinal', ruler: 'venus',   startMonth: 9,  startDay: 23, endMonth: 10, endDay: 22 },
    { id: 'scorpio', emoji: '♏',     element: 'water', modality: 'fixed',    ruler: 'mars',    startMonth: 10, startDay: 23, endMonth: 11, endDay: 21 },
    { id: 'sagittarius', emoji: '♐', element: 'fire',  modality: 'mutable',  ruler: 'jupiter', startMonth: 11, startDay: 22, endMonth: 12, endDay: 21 },
    { id: 'capricorn', emoji: '♑',   element: 'earth', modality: 'cardinal', ruler: 'saturn',  startMonth: 12, startDay: 22, endMonth: 1,  endDay: 19 },
    { id: 'aquarius', emoji: '♒',    element: 'air',   modality: 'fixed',    ruler: 'saturn',  startMonth: 1,  startDay: 20, endMonth: 2,  endDay: 18 },
    { id: 'pisces', emoji: '♓',      element: 'water', modality: 'mutable',  ruler: 'jupiter', startMonth: 2,  startDay: 19, endMonth: 3,  endDay: 20 }
  ],
